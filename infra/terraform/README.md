...
4. Apply `aws-image-canary-target` in every compute account and region that will
   be qualified, then pass those exact role ARNs to the worker identity module.
5. Import the generated, secret-free qualification manifest and deploy the
