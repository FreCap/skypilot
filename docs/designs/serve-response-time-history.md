...
Migration 022 creates `serve_response_time_history`. The central Serve DB path
...
Deploy API server and migration 022 before or with new controllers. The schema
...
- Execute migration 022 against real PostgreSQL and verify array constraints,
