...
| 2c | P2c provider-independent route leases and safe zero-demand paid retirement (Serve051/API88) | PR #1531 is merged and deployed dark as direct Helm revision 409 / v1.1.1313. Its first production gate exposed an omitted-field producer-bootstrap defect; the exact-owner fix-forward and provider-stall qualification remain open. #1506 remains its stacked removal. |
