...
| 2c | P2c provider-independent route leases and safe zero-demand paid retirement (Serve051/API88) | PR #1531 is merged and deployed dark. PR #1532's exact-owner fix is deployed as revision 410 / v1.1.1314 and selected protocol 2, but production exposed a second shared routing-epoch-lock dependency. The immutable route-contract fix-forward and provider-stall qualification remain open. #1506 remains its stacked removal. |
