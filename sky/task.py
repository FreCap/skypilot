...
class Task:
    ...
    def from_yaml_config(
        ...
        return task_yaml_lib.from_yaml_config(
            Task,
            ManagedSecretRef,
            config,
    ...
    def get_resource_config(self) -> dict[str, Any]:
        return task_yaml_lib.resources_to_config(self.resources,
    ...
    def _to_yaml_config(self, redact_secrets: bool = False) -> dict[str, Any]:
        return task_yaml_lib.to_yaml_config(self, redact_secrets=redact_secrets)
