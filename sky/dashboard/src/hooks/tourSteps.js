...
export function createTourSteps(router, tourNavigatingRef) {
  return [
    {
            ...
            if (window.innerWidth < 768) {
              ...
              if (!mobileMenu) {
                ...
                for (const div of allDivs) {
                  ...
                  if (rect.width === 256 && rect.left === 0 && rect.top >= 50) {
                    // w-64 = 256px
                    mobileMenu = div;
                    break;
                  }
    ...
    },
    {
      ...
      attachTo: {
        element: function () {
          ...
          ).find((th) => th.textContent && th.textContent.trim() === 'Infra');
      ...
      attachTo: {
        element: function () {
          ...
          const userHeader = Array.from(
            document.querySelectorAll('thead th')
          ).find((th) => th.textContent && th.textContent.trim() === 'User');
