...
from sky.jobs.client import log_download
...
def download_logs_streaming(
    ...
    Returns:
        ...
        (non-controller).
    """
    return log_download.download_logs_streaming(name, job_id, refresh,
...
def download_logs(
    ...
    return log_download.download_logs(name, job_id, refresh, controller,
                                      local_dir)
