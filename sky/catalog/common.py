...
def merge_pricing_dicts(base: dict[str, Any],
    ...
    """Compatibility facade for virtual-instance pricing merge policy."""
    return pricing_utils.merge_pricing_dicts(base, override)


def resolve_pricing_config(
        *config_key_paths: tuple[str, ...]) -> dict[str, Any]:
    """Compatibility facade for virtual-instance pricing resolution."""
    return pricing_utils.resolve_pricing_config(*config_key_paths)
...
def get_hourly_cost_from_pricing(
    ...
    """Compatibility facade for virtual-instance hourly cost policy."""
