...
from sky.utils import debug_dump_cluster
...
_SKYLET_LOG_RESOLVE_CONNECT_TIMEOUT = (
    debug_dump_cluster.SKYLET_LOG_RESOLVE_CONNECT_TIMEOUT)
_SKYLET_LOG_RSYNC_TIMEOUT = debug_dump_cluster.SKYLET_LOG_RSYNC_TIMEOUT
_resolve_remote_skylet_log_path = (
    debug_dump_cluster.resolve_remote_skylet_log_path)
_collect_cluster_skylet_log = debug_dump_cluster.collect_cluster_skylet_log
