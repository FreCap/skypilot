...
# Keep the historical helper paths and pickle identities while monitoring.py
# owns their implementation.
_dcgm_exporter_service_cmd = monitoring._dcgm_exporter_service_cmd  # pylint: disable=protected-access
_prometheus_install_cmd = monitoring._prometheus_install_cmd  # pylint: disable=protected-access
_dcgm_exporter_service_cmd.__module__ = __name__
_prometheus_install_cmd.__module__ = __name__
...
def deploy_single_cluster(cluster_name,
    ...
    monitoring.install_monitoring(cluster_name, head_node, ssh_user, ssh_key,
                                  askpass_block, install_gpu,
                                  head_use_ssh_config)
