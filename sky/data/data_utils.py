...
from sky.data import rclone_utils
...
Rclone = rclone_utils.Rclone
# Preserve the long-standing facade identity for introspection and pickle.
Rclone.__module__ = __name__
Rclone.RcloneStores.__module__ = __name__
# Preserve dependency patch points used through the historical facade.
clouds = rclone_utils.clouds
constants = rclone_utils.constants
subprocess = rclone_utils.subprocess
