...
from sky.data import mounting_script
...
def _get_mount_binary(mount_cmd: str) -> str:
    ...
    """
    return mounting_script.get_mount_binary(mount_cmd)
...
def get_mounting_script(
    ...
    """
    return mounting_script.get_mounting_script(
        mount_path,
        mount_cmd,
        install_cmd,
        version_check_cmd,
...
def get_mounting_command(
    ...
    # use a random identifier to avoid temporary script collisions.
    return mounting_script.get_mounting_command(script,
                                                script_id=random.randint(
                                                    0, 1000000))
