...
from sky.utils import accelerator_availability
...
def realtime_kubernetes_gpu_availability(
    ...
    """
    return accelerator_availability.realtime_kubernetes_gpu_availability(
        context=context,
...
def realtime_slurm_gpu_availability(
    ...
    **kwargs,
    ...
    """
    return accelerator_availability.realtime_slurm_gpu_availability(
