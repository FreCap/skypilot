...
SKIPPED_CLIENT_OVERRIDE_KEYS: list[tuple[str, ...]] = [
    ...
    ('kubernetes', 'serve_controller_priority_class_name'),
    ('kubernetes', 'serve_worker_cache'),
    ('kubernetes', 'serve_worker_scratch'),
    ('kubernetes', 'serve_worker_priority_class_name'),
    ('kubernetes', 'serve_worker_kueue_workload_priority_class_name'),
    ...
    ('kubernetes', 'context_configs', '*', 'serve_worker_scratch'),
...
EXECUTION_DRAIN_SECONDS_ENV_VAR = (SKYPILOT_ENV_VAR_PREFIX +
                                   'EXECUTION_DRAIN_SECONDS')
