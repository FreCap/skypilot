...
PEEK_HEAD_LINES_FOR_START_STREAM = log_reader.PEEK_HEAD_LINES_FOR_START_STREAM
...
def tail_lines_from_end(path: str,
    ...
    return log_reader.tail_lines_from_end(path, tail, offset)


def _peek_head_lines(log_file: TextIO) -> list[str]:
    """Peek the head of the file."""
    return log_reader.peek_head_lines(log_file)
...
def _should_stream_the_whole_tail_lines(head_lines_of_log_file: list[str],
    ...
    return log_reader.should_stream_the_whole_tail_lines(
