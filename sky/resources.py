...
from sky import resources_serialization
...
class Resources:
    ...
    * for provisioning on a cloud
    ...
    def __getstate__(self) -> dict[str, Any]:
        ...
        """
        return resources_serialization.getstate(self)

    def __setstate__(self, state):
        """Set state from pickled state, for backward compatibility."""
        resources_serialization.setstate(
            self,
            state,
            current_version=self._VERSION,
            default_disk_size_gb=DEFAULT_DISK_SIZE_GB,
            maybe_add_docker_prefix_to_image_id=(
                _maybe_add_docker_prefix_to_image_id),
            normalize_hook_entry=_normalize_hook_entry,
        )
