...
_CONTROLLER_AUTHORITY_ENV_VARS = (
    ...
    'SKYPILOT_SERVER_CONFIG_SNAPSHOT_KIND',
    'SKYPILOT_SERVER_CONFIG_SNAPSHOT_PATH',
    'SKYPILOT_SERVER_CONFIG_SNAPSHOT_DIGEST',
    'SKYPILOT_SERVER_CONFIG_SNAPSHOT_IDENTITY',
